const usersEl = ({ fullName, userId, selected, active, date }) => {
	return `
		<tr data-userid="${userId}">
		  ...
		  <td class="text-nowrap align-middle"><span>${date}</span></td>
		  ...
		  <td class="text-center align-middle">
		    <div class="btn-group align-top">
		        ...
		        <button class="btn btn-sm btn-outline-secondary badge" type="button"><i onclick="deleteUser(this)" class="fa fa-trash"></i></button>
		    </div>
		  </td>
		</tr>
	`
